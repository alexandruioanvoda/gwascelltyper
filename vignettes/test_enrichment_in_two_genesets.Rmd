...
```{r eval=FALSE}
download.file(url = "ftp://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/deLangeKM_28067908_GCST004132/cd_build37_40266_20161107.txt.gz",
              destfile = paste0(getwd(), "/cd_build37_40266.txt.gz"))
library(R.utils)
gunzip("cd_build37_40266.txt.gz", remove=TRUE)
```

Now, you should have a file called `cd_build37_40266.txt` in your working directory (`getwd()`).
